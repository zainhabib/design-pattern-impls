...
class MoneyTransferCommmand(CompositeBankAccountCommand):
...
class TestSuite(unittest.TestCase):
    ...
    def test_better_transfer(self):
        ...
        transfer = MoneyTransferCommmand(ba1, ba2, amount)
        transfer.invoke()
        print(f"ba1: {ba1}, ba2: {ba2}")
        transfer.undo()
        print(f"ba1: {ba1}, ba2: {ba2}")
...
def main():
    ...
    cmd.invoke()
    print(f"After $100 deposite: {ba}")

    cmd.undo()
    print(f"$100 deposite undone: {ba}")
    ...
    illegal_cmd.undo()
    print(f"After impossible withdrawal undone: {ba}")
